...
# base: !gdown 1FAdRNrpfXby2mNfqx2Q-FZjtBm7NTSzS
# replace: !gdown 13XzRYAtvQAYRcVd2ki0r31lvz3fh0IQN
# NSR: !gdown 1mPQAI1vPWc3XVL5Fb9495tpBku2-3eKv
# swap: !gdown 1IaOf0q9rBH5_PEJexkaTclvLoRvW32Oh
# negate: !gdown 1RDwxQctUsOI1-n88k8ok5Vq7KDeY_Kdp
import torch
...
model.load_state_dict(torch.load('epoch_5.pt')['state_dict'])
model.eval()
